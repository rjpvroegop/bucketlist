...
```shell
gulp build
electron bucketlistitemsholder.js
```
...
7. To start the app, execute the following command:
  ...
  electron bucketlistitemsholder.js
  ```
>**Note:** If typing the command `electron bucketlistitemsholder.js` is too much for you change this line in package.json from `"main": "dist/main.js",` to `"main": "bucketlistitemsholder.js",`
...
>**Note:** The electron-packager package relies on `"main"` in package.json to know which JS file to use to start the application. To make this work with electron-packager change this line in package.json from `"main": "dist/main.js",` to `"main": "bucketlistitemsholder.js",`
